...
def print_tree(
    directory, prefix="", max_depth=None, current_depth=0, show_hidden=False
):
    """
...
def main():
    ...
    parser.add_argument("--no-size", action="store_true", help="Don't show file sizes")
    ...
    print_tree(project_path, max_depth=args.max_depth, show_hidden=args.show_hidden)
